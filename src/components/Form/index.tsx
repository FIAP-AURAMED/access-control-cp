            ...
            <fieldset className="w-full md:w-250 max-w-md p-10 space-y-6 bg-white rounded-lg shadow-md">
                ...
                {fields.includes('nome') && (
                    <div>
                        ...
                        <input type="text" id="nome" placeholder="Digite seu nome" className="block w-full text-sm px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500" {...register('nome', { required: 'O nome é obrigatório' })} />
                ...
                {fields.includes('nomeUsuario') && (
                    <div>
                        ...
                        <input type="text" id="nomeUsuario" placeholder="Digite o nome de usuário" className="block w-full text-sm px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500" {...register('nomeUsuario', { required: 'O nome de usuário é obrigatório' })} />
                ...
                {fields.includes('email') && (
                    <div>
                        ...
                        <input type="email" id="email" placeholder="Digite seu e-mail" className="block w-full text-sm px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500" {...register('email', { required: 'O nome de usuário é obrigatório' })} />
