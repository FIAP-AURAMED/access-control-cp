            ...
            <fieldset className="w-full md:w-250 max-w-md p-10 space-y-6 bg-white rounded-lg shadow-md">
                ...
                {fields.includes('email') && (
                    <div>
                        ...
                        <input type="email" id="email" placeholder="Digite seu e-mail" className="block w-full text-sm px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500" {...register('email', { required: 'O email é obrigatório' })} />
